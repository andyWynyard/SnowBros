  ...
  <div class="row">
 	<div class="col-sm-6">
  		...
  		<form action="viewTrip.do" method="GET">
         		<p><input type="submit" class="btn btn-info btn-block btn-lg" value="${trips.destination.name} on ${trips.date}"></p>
  	...
  	<div class="col-sm-6">
		...
		<h3>Your SnowBros</h3>	
  		...
  		<form action="ViewUser.do" method="GET">
         		<p><input type="submit" class="btn btn-success btn-block btn-lg" value="${bro.firstName} ${bro.lastName}"></p>
